...
function ListTodo(props) {
    ...
    //Every individual todo listed on the app can be deleted upon being clicked. onClickHandler passes the id of that specific todo so it can be deleted in Todo.js
